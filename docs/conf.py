...
"""
repo-tools-data-schema documentation build configuration file.
...
project = 'repo-tools-data-schema'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'repo-tools-data-schema'
...
#
# html_title = 'repo-tools-data-schema v1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Schema for repo-tools-data',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'repo_tools_data_schema'),
                os.path.join(root_path, 'repo_tools_data_schema/migrations')])
